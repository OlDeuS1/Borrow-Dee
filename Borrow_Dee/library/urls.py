...
urlpatterns = [
    ...
    path('api/categories/<int:category_id>/', views.CategoryDelete.as_view(), name="category-delete"),
    path('api/books/<int:book_id>/', views.BookDelete.as_view(), name="book-delete"),
